...
#ifndef __CHIP_K1_HARDWARE_K1_USBDEV_H
#define __CHIP_K1_HARDWARE_K1_USBDEV_H
...
#define K1_EHCI_NRHPORT                 1

/* K1 MV/ChipIdea USB2 device controller.  The resource begins at the
 * capability block, so operational offsets below are capability-relative.
 */

#define K1_USBDEV_BASE                  0xc0900100ul
#define K1_USBDEV_PHY_BASE              0xc0940000ul
#define K1_USBDEV_APMU_CTRL             (0xd4282800ul + 0x05cul)
#define K1_USBDEV_CLK_EN                (1ul << 1)
#define K1_USBDEV_RESET                 (1ul << 0)

#define K1_USBDEV_PHY_PLL_CTRL          0x04ul
#define K1_USBDEV_PHY_HSTXP_CTRL        0x34ul
#define K1_USBDEV_PHY_HSDAC_CTRL        0xa4ul
#define K1_USBDEV_PHY_REFCLK_CTRL        0x98ul
#define K1_USBDEV_PHY_HS_SRC            0x18ul
#define K1_USBDEV_PHY_DISC_CTRL         0x10ul
#define K1_USBDEV_PHY_PLL_READY         (1ul << 0)
#define K1_USBDEV_PHY_HS_SRC_SEL        (1ul << 0)
#define K1_USBDEV_PHY_DISC_AUTO_CLEAR   (1ul << 2)

#define K1_USBOTG_ID_OFFSET             0x000 /* Identification */
#define K1_USBHOST_HWGENERAL_OFFSET     0x004 /* Hardware General */
#define K1_USBHOST_HWHOST_OFFSET        0x008 /* Host Hardware Parameters */
#define K1_USBHOST_HWDEVICE_OFFSET      0x00c /* Device Hardware Parameters */
#define K1_USBHOST_HWTXBUF_OFFSET       0x010 /* TX Buffer Hardware Parameters */
#define K1_USBHOST_HWRXBUF_OFFSET       0x014 /* RX Buffer Hardware Parameters */
#define K1_USBHOST_GPTIMER0LD_OFFSET    0x080 /* General Purpose Timer #0 Load */
#define K1_USBHOST_GPTIMER0CTRL_OFFSET  0x084 /* General Purpose Timer #0 Controller */
#define K1_USBHOST_GPTIMER1LD_OFFSET    0x088 /* General Purpose Timer #1 Load */
#define K1_USBHOST_GPTIMER1CTRL_OFFSET  0x08c /* General Purpose Timer #1 Controller */
#define K1_USBHOST_SBUSCFG_OFFSET       0x090 /* System Bus Config */

/* Device/host capability registers */

#define K1_USBOTG_CAPLENGTH_OFFSET      0x000 /* Capability register length (8-bit) */
#define K1_USBHOST_HCIVERSION_OFFSET    0x102 /* Host interface version number (16-bit) */
#define K1_USBHOST_HCSPARAMS_OFFSET     0x104 /* Host controller structural parameters */
#define K1_USBHOST_HCCPARAMS_OFFSET     0x108 /* Host controller capability parameters */
#define K1_USBDEV_DCIVERSION_OFFSET     0x120 /* Device interface version number */
#define K1_USBDEV_DCCPARAMS_OFFSET      0x124 /* Device controller capability parameters */

/* Device/host/OTG operational registers */

#define K1_USBOTG_USBCMD_OFFSET         0x140 /* USB command (both) */
#define K1_USBOTG_USBSTS_OFFSET         0x144 /* USB status (both) */
#define K1_USBOTG_USBINTR_OFFSET        0x148 /* USB interrupt enable (both) */
#define K1_USBOTG_FRINDEX_OFFSET        0x14c /* USB frame index (both) */
#define K1_USBOTG_DEVICEADDR_OFFSET     0x154 /* USB device address (device) */
#define K1_USBOTG_ASYNCLISTADDR_OFFSET  0x158 /* Next asynchronous list address (host) */
#define K1_USBOTG_ENDPOINTLIST_OFFSET   0x158 /* Address of endpoint list in memory (device) */
#define K1_USBOTG_BURSTSIZE_OFFSET      0x160 /* Programmable burst size (both) */
#define K1_USBOTG_TXFILLTUNING_OFFSET   0x164 /* Host transmit pre-buffer packet tuning (host) */
#define K1_USBOTG_ENDPTNAK_OFFSET       0x178 /* Endpoint NAK (device) */
#define K1_USBOTG_ENDPTNAKEN_OFFSET     0x17c /* Endpoint NAK Enable (device) */
#define K1_USBOTG_CONFIGFLAG_OFFSET     0x180 /* Configured flag register (not used in lpc313x) */
#define K1_USBOTG_PORTSC1_OFFSET        0x184 /* Port status/control 1 (both) */
#define K1_USBOTG_OTGSC_OFFSET          0x1a4 /* OTG status and control (otg) */
#define K1_USBOTG_USBMODE_OFFSET        0x1a8 /* USB device mode (both) */

#define K1_USBDEV_CAPLENGTH_OFFSET     0x00  /* Capability length */
#define K1_USBDEV_USBCMD_OFFSET        0x40  /* USB command (both) */
#define K1_USBDEV_USBSTS_OFFSET        0x44  /* USB status (both) */
#define K1_USBDEV_USBINTR_OFFSET       0x48  /* USB interrupt enable (both) */
#define K1_USBDEV_FRINDEX_OFFSET       0x4c  /* USB frame index (both) */
#define K1_USBDEV_DEVICEADDR_OFFSET    0x54  /* USB device address (device) */
#define K1_USBDEV_ENDPOINTLIST_OFFSET  0x58  /* Endpoint list address */
#define K1_USBDEV_BURSTSIZE_OFFSET     0x60  /* Programmable burst size */
#define K1_USBDEV_ENDPTNAK_OFFSET      0x78  /* Endpoint NAK */
#define K1_USBDEV_ENDPTNAKEN_OFFSET    0x7c  /* Endpoint NAK enable */
#define K1_USBDEV_PORTSC1_OFFSET       0x84  /* Port status/control 1 */
#define K1_USBDEV_USBMODE_OFFSET       0xa8  /* USB device mode */

#define K1_USBHOST_USBCMD_OFFSET        0x140 /* USB command (both) */
#define K1_USBHOST_USBSTS_OFFSET        0x144 /* USB status (both) */
#define K1_USBHOST_USBINTR_OFFSET       0x148 /* USB interrupt enable (both) */
#define K1_USBHOST_FRINDEX_OFFSET       0x14c /* USB frame index (both) */
#define K1_USBHOST_PERIODICLIST_OFFSET  0x154 /* Frame list base address (host) */
#define K1_USBHOST_ASYNCLISTADDR_OFFSET 0x158 /* Next asynchronous list address (host) */
#define K1_USBHOST_TTCTRL_OFFSET        0x15c /* Asynchronous buffer status for embedded TT (host) */
#define K1_USBHOST_BURSTSIZE_OFFSET     0x160 /* Programmable burst size (both) */
#define K1_USBHOST_TXFILLTUNING_OFFSET  0x164 /* Host transmit pre-buffer packet tuning (host) */
#define K1_USBHOST_PORTSC1_OFFSET       0x184 /* Port status/control 1 (both) */
#define K1_USBHOST_USBMODE_OFFSET       0x1a8 /* USB device mode (both) */

/* Device endpoint registers */

#define K1_USBDEV_ENDPTSETUPSTAT_OFFSET 0xac /* Endpoint setup status */
#define K1_USBDEV_ENDPTPRIME_OFFSET     0xb0 /* Endpoint initialization */
#define K1_USBDEV_ENDPTFLUSH_OFFSET     0xb4 /* Endpoint de-initialization */
#define K1_USBDEV_ENDPTSTATUS_OFFSET    0xb8 /* Endpoint status */
#define K1_USBDEV_ENDPTCOMPLETE_OFFSET  0xbc /* Endpoint complete */

#define K1_USBDEV_ENDPTCTRL_OFFSET(n)  (K1_USBDEV_ENDPTCTRL0_OFFSET + ((n) * 4))
#define K1_USBDEV_ENDPTCTRL0_OFFSET    0xc0 /* Endpoint control 0 */
#define K1_USBDEV_ENDPTCTRL1_OFFSET    0xc4 /* Endpoint control 1 */
#define K1_USBDEV_ENDPTCTRL2_OFFSET    0xc8 /* Endpoint control 2 */
#define K1_USBDEV_ENDPTCTRL3_OFFSET    0xcc /* Endpoint control 3 */
#define K1_USBDEV_ENDPTCTRL4_OFFSET    0xd0 /* Endpoint control 4 */
#define K1_USBDEV_ENDPTCTRL5_OFFSET    0xd4 /* Endpoint control 5 */
#define K1_USBDEV_ENDPTCTRL6_OFFSET    0xd8 /* Endpoint control 6 */
#define K1_USBDEV_ENDPTCTRL7_OFFSET    0xdc /* Endpoint control 7 */

/* USB Non-core memory map & register definition */

#define K1_USBNC_CTRL1_OFFSET           0x0200 /* USB OTG Control Register 1 */
#define K1_USBNC_CTRL2_OFFSET           0x0204 /* USB OTG Control Register 2 */
#define K1_USBNC_UTMIPHY_CFG1_OFFSET    0x0230 /* PHY Configure 1 */
...
#define USBDEV_PRTSC1_PTS_SHIFT              (30)      /* Bits 30-31: PHY interface select */
#define USBDEV_PRTSC1_PTS_MASK               (0x3 << USBDEV_PRTSC1_PTS_SHIFT)
#  define USBDEV_PRTSC1_PTS_ULPI             (2 << USBDEV_PRTSC1_PTS_SHIFT)
...
#endif /* __CHIP_K1_HARDWARE_K1_USBDEV_H */
