...
inline constexpr std::size_t kMaxNavMapCells = 65536;
inline constexpr std::size_t kMaxNavPathNodes = 8192;
...
struct NavMapView {
    ...
    bool WorldToCell(const Eigen::Vector2d& point, GridCell& cell) const {
    ...
    Eigen::Vector2d CellCenter(GridCell cell) const {
    ...
    double DistanceToOccupied(const Eigen::Vector2d& point,
...
struct PoseSnapshot {
    ...
    Eigen::Vector2d planar_velocity = Eigen::Vector2d::Zero();
    double yaw_rate = 0.0;
